...
namespace MvcNews.Controllers
{
    public class NewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RowVersion,Id,TimeStamp,Text")] NewsItem newsItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RowVersion,Id,TimeStamp,Text")] NewsItem newsItem)
        {
            if (id != newsItem.Id)
            {
                return NotFound();
